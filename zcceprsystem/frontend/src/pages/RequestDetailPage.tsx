...
const RequestDetailPage: React.FC = () => {
  ...
  const canApprove = () => {
    ...
    // or at PENDING_LEAD_APPROVAL (own department only)
    ...
    // HOP can approve at PENDING_ADMIN_APPROVAL, PENDING_LEAD_APPROVAL, PENDING_HOP_APPROVAL
...
${buildClaimPage()}
  ...
  return (
    <Box>
      ...
      {/* Approve Dialog */}
      <Dialog open={showApproveDialog} onClose={() => setShowApproveDialog(false)} maxWidth="lg" fullWidth>
